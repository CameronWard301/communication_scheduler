...
## Overview
This project is a communication scheduling platform that allows business to schedule messages to be sent to customers on a recurring basis.
...
* Uses [Temporal](https://temporal.io) (a fault-tolerant and scalable orchestration engine) to manage the scheduling of messages and ensures messages are always delivered.
...
* [Designs](Designs) - Contains context, cost analysis, sequence, deployment and activity diagrams explaining the project in more detail
* [Communication Worker](communication-worker) - Worker that polls the Temporal task queue and triggers gateways to send messages
