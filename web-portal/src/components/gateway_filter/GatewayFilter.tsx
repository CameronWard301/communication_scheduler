...
const GatewayFilter = observer(({isFieldFocused,
                                  setIsFieldFocused,
                                  setFieldValue,
                                  fieldValue,
                                  InputIcon,
  ...
  }, [rootStore.gatewayFilterStore.paginationModel, rootStore.gatewayFilterStore.sortModel]);
          ...
          <Button variant={"outlined"}
                  startIcon={InputIcon && (
                    <Badge color={"primary"} variant={"dot"} invisible={fieldValue == ""}>
                      <InputIcon sx={{color: 'action.active', mr: -0.5, my: -0.5, width: '35px', height: '35px'}} fontSize="large"/>
                    </Badge>

                  )}
                  fullWidth
                  size={"large"}
                  endIcon={isFieldFocused ? <ArrowDropUpRoundedIcon sx={{justifyContent: "flex-end"}}/> : <ArrowDropDownRoundedIcon/>}
                  color={"info"}
              ...
              <Grid container spacing={2}>
                ...
                <Grid xs={12} md={6}>
                  <Button id={`${idPrefix}-filter-apply-button`} aria-haspopup="true"
                          ...
                          onClick={() => {setTextField(rootStore.gatewayFilterStore.rowSelectionModel.length > 0? rootStore.gatewayFilterStore.gatewayTableData[0].id : "", queryParam); setIsFieldFocused(false)}}
                          >
                    Apply Filter
                  </Button>
                </Grid>
