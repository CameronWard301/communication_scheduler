...
export const useGatewayService = () => {
  ...
  return {getGatewaysForScheduleFilter, getGatewaysForTable, fetchGatewayPage, getAffectedSchedules, deleteGatewayById, getGatewayById, updateGateway, createGateway}
}
