...
locals {
  ...
  base_source_url = "../../../../../terraform//eks"

  account_tags = read_terragrunt_config(find_in_parent_folders("default-tags.hcl"))
  env_tags     = {
    RepoURL = "https://github.com/CameronWard301/communication_scheduler/tree/master/deployment/terraform/eks"
  }
}
...
inputs = {
  ...
  eks_private_subnet_ids = [
    dependency.networking.outputs.private_subnet_1a_id, dependency.networking.outputs.private_subnet_1b_id
  ]
