...
public class WorkflowDTOConverters {
    ...
    public WorkflowExecutionDTO convertToDTO(WorkflowExecutionMetadata workflowExecutionMetadata){
        WorkflowExecutionDTO workflowExecutionDTO = WorkflowExecutionDTO.builder()
                ...
                .userId(workflowExecutionMetadata.getTypedSearchAttributes().get(SearchAttributeKey.forText("userId")))
                .gatewayId(workflowExecutionMetadata.getTypedSearchAttributes().get(SearchAttributeKey.forText("gatewayId")))
                .scheduleId(workflowExecutionMetadata.getTypedSearchAttributes().get(SearchAttributeKey.forText("scheduleId")))
